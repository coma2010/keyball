...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_DEFAULT] = LAYOUT_universal(
        ...
        LGUI_T(KC_CAPS), LSFT_T(KC_A), LALT_T(KC_S), LGUI_T(KC_D), LT(_BRACKET, KC_F), LT(_MOUSE, KC_G), KC_H, LT(_MOUSE, KC_J), LGUI_T(KC_K), LALT_T(KC_L), RSFT_T(KC_MINS), LT(_MISC, KC_ENT),
    ...
    [_NUMBER] = LAYOUT_universal(
        ...
        _______, LSFT_T(KC_1), KC_2, KC_3, LT(_BRACKET, KC_4), LT(_MOUSE, KC_5), TD(TD_6), TD(TD_7), TD(TD_8), TD(TD_9), TD(TD_00), _______,
